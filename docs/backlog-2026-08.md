...
| F17 | L-064 allocation-circle competition proxy | #299 | partial — circle proxy validated and found NOT predictive; candidate-weighting no better. 2026-08-28 BREAKTHROUGH: the GEOMETRY was the problem — OPO catchments DO predict (kidney ρ −0.188 p0.005, lung −0.361 p0.004 controlling for volume; UNOS region null as control). Effect is real but small (~3.5% of rank variance). #299 stays open to build the OPO-based term and rewrite the Explorer caveat |
