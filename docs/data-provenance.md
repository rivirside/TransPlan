...
| Competing risks rates (mortality/delisting) | SRTR annual reports + literature | None (planned: M4) | No | Planned: `data/competing-risks.json` | Not yet created |
...
| Competing risks data not created | No mortality/delisting modeling yet | Planned for M4 | M4 |
