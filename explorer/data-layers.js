/**
 * explorer/data-layers.js — Data Layers tab for the unified Explorer page
 *
 ...
 *
 * Extracted from data-explorer.js and converted to a lazily-initialized module.
 * Call TransPlanDataLayers.init() to set up — do NOT auto-execute.
 *
 * Expects Leaflet, leaflet.markercluster, and topojson-client loaded before
 * this script.
 *
 * All DOM construction uses safe methods (createElement, textContent, appendChild).
...
(function () {
  ...
  /* ===================================================================
     4. MODULE-LEVEL STATE (set during init)
     =================================================================== */
  ...
  function createClusterGroup() {
    return L.markerClusterGroup({
      ...
      iconCreateFunction: function (cluster) {
        ...
        iconDiv.textContent = String(count);
        return L.divIcon({
  ...
  /* ===================================================================
     10. REBUILD CENTER DOTS (on organ filter change)
     =================================================================== */
  ...
  function init() {
    ...
    loadJSON('data/srtr-all-centers.json').then(function (data) {
      ...
      console.warn('data-layers: could not load center data', err);
    });
  }
  ...
  window.TransPlanDataLayers = { init: init };
