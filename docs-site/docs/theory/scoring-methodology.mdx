...
<HeatmapTable
  rows={['Houston', 'Pittsburgh', 'Cleveland', 'Minneapolis', 'Nashville', 'Chicago']}
  columns={['Med. Compat.', 'Wait Time', 'Donor Avail.', 'Hosp. Quality', 'Geo/Logistic', 'Health Demo.', 'Policy', 'Socioeconomic']}
  data={[
    [72, 45, 68, 85, 62, 58, 70, 65],
    [78, 62, 72, 92, 55, 64, 72, 60],
    [75, 58, 70, 95, 50, 60, 68, 58],
    [74, 70, 75, 88, 48, 72, 74, 62],
    [70, 52, 65, 80, 65, 55, 66, 63],
    [76, 55, 71, 90, 45, 56, 70, 60],
  ]}
  formatCell={(v) => v.toFixed(0)}
  colorScale="green"
  title="Category Scores by City (Kidney, O+ Blood Type)"
  domain={[40, 100]}
/>
