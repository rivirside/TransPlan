...
from routers import centers, equity, health, score, sensitivity, shutdown, simulate, spatial, tier, trends, validation, what_if, rank_stability, multi_listing, weight_range
...
app.include_router(weight_range.router, tags=["simulation"], dependencies=_sim_deps)
app.include_router(multi_listing.router, tags=["simulation"], dependencies=_sim_deps)
