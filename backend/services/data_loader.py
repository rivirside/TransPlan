...
class TransPlanData:
    ...
    county_trauma: dict = field(default_factory=dict)
    ...
    waitlist_composition: dict = field(default_factory=dict)
...
def load_all() -> TransPlanData:
    ...
    data.waitlist_composition = _load_json(DATA_DIR / "waitlist-composition.json", "waitlist_composition", data)
    ...
    data.county_trauma      = _load_json(DATA_DIR / "trauma-scores-counties.json", "county_trauma",  data)
